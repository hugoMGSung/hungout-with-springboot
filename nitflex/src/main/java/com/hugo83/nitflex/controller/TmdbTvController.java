...
import com.hugo83.nitflex.service.TmdbTvService;
...
public class TmdbTvController {
	...
	public Object getTvImage(@RequestParam(value = "id") String id)
	...
	public String getRealTvImage(@RequestParam(value = "image") String image)
			throws JsonMappingException, JsonProcessingException {
	...
	public Object getTvVideo(@RequestParam(value = "id") String id)
			throws JsonMappingException, JsonProcessingException {
